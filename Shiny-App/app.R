  ...
  dashboardBody(
    ...
    tabItems(
              ...
              fluidRow(
                ...
                column(
                  ...
                  box(
                    ...
                    solidHeader = T,
                    collapsible = T,
                    img(src = "graphics/my_animation.gif", width = "550px", height = "400px")
                  )
                ),
                column(
                  width = 4,
                  box(
                    ...
                    solidHeader = T,
                    collapsible = T,
                    img(src = "graphics/olympic-rings.png", width = "270px", height = "400px")
                  )
                )
              ),
              fluidRow(
      ...
      tabItem(tabName = "page4",
              ...
              tags$head(
                tags$link(rel = "stylesheet", type = "text/css", href = "graphics/olympics.css")
              ),
